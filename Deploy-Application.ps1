...
Try {
	...
	[string]$appVendor = 'CodeBlocks'
	[string]$appName = 'CodeBlocks'
	[string]$appVersion = '17.12'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'codeblocks' -CheckDiskSpace -PersistPrompt
		...
		Execute-Process -Path "$dirFiles\codeblocks-17.12mingw-setup.exe" -Parameters '/S' -WindowStyle 'Hidden'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Execute-Process -Path "C:\Program Files (x86)\CodeBlocks\uninstall.exe" -Parameters "/S"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBNebIF5ZlFWt6P
# 3Vfe1gZ6cp9o1sQD8Hp2J2ERW+L5uKCCFFwwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQge/Zc+RCN
# xwBBrbKk8plwEeEzUox4pkx3Cd4mzODCUKYwDQYJKoZIhvcNAQEBBQAEggEAZ0f2
# KYUXCvUKWKX2l6OpGaVIc31+J0xF+4QOEZem1klzN4AY+K3zRVfW5Ge/rXwjjMfr
# zo6+wABxVbi1oLImeCtXhLCFdbP4rAvPDvOFkB5vmkzaZGhGWy32s0wpek4w+8ZS
# QGkppGgPZFcNjZzpxTYLH5ImEP0wJ5W1HKZ7trX5qahMq1Ty/Un72P/TB/XN6UTL
# I5G+J5092M0cz30eLrIVD4w34jJCen5DZUYV8wOt4UFyzL+An5D6L3NklWRN16Hp
# kkEWBo/kw0uMvhnaDTZAnQwJkGy6aG1pN+wic29j/k9yWs/qWww2qiMFL0Vvdgol
# yyTT3O7wPfakmvxLe6GCAqIwggKeBgkqhkiG9w0BCQYxggKPMIICiwIBATBoMFIx
...
# CSqGSIb3DQEJBTEPFw0xODA3MTkxNDQwMTZaMCMGCSqGSIb3DQEJBDEWBBSklYO+
# i9lFhDUp7HPZIjfg9wRoCDCBnQYLKoZIhvcNAQkQAgwxgY0wgYowgYcwgYQEFGO4
...
# ggEAElf0VOhbLBCgrikdXMmP56pQweVWNaL/yRE84S8fuTAqrdrUH8looJohBBkB
# lrQekUvU69TepBaqEJQaGPGeTTqPcTDiboSNwnWLjI1Fp4z1QGvC7/gjPQ3MRMqB
# Fds+XGoX7DiUKxO0rF7rwFeGAKn3RVpol3XsPy7e+3yyz+rUlgwON0rfsdBq0LGm
# vWhZ9CzFT5euiX45iOBexMLjo37iwylZJYXuCE5VYIXPC7t9LvsK6cbEUE4GlO2e
# pAffu3VuhniqTjItHB+Ei4/FHLN2xSTEdEwplPT9Py9C52UB5caDC2Z2UC60i2Gh
# 5BotHlL042cRXcmur9EwMvR3lw==
